...
const DetailedAdmin = () => {
  return (
    <div className="bg-[#000000] w-full p-10">
      ...
      <div className="w-[100%] flex justify-between pt-8 pb-8 space-x-3">
        ...
        <div className="w-[50%] bg-[#212121] rounded-xl space-y-8 text-white flex flex-col justify-end items-end">
          <h1 className="flex cursor-pointer items-center underline text-2xl font-Lora">
            <AiFillRead />
            Information for Clients
          </h1>
          <p className="flex cursor-pointer items-center underline text-2xl font-Lora">
      ...
      <div className="flex w-full">
        <div className="w-[50%] flex flex-col justify-center items-center border-2 border-green-200 text-white">
          <p className="font-Lora text-xl">All earning from start</p>
